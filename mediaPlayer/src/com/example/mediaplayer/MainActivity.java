...
public class MainActivity extends Activity {
	...
	protected void play(){
		...
		if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
			/**
			String innPath = SDUtil.getInnerSDCardPath();
			List<String> extPaths = SDUtil.getExtSDCardPath();
			String extPath = "";
			...
			*/
			...
			file = new File(path[0].getPath() + "/music.mp3");
			editPath.setText(file.getPath());
